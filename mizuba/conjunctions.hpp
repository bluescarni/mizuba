...
class conjunctions
{
    ...
    std::vector<double> compute_aabbs(const polyjectory &, const boost::filesystem::path &, std::size_t, double,
                                      double) const;
    void morton_encode_sort(const polyjectory &, const boost::filesystem::path &, std::size_t,
    ...
    broad_phase(const polyjectory &, const boost::filesystem::path &, std::size_t,
                const std::vector<std::tuple<std::size_t, std::size_t>> &, const std::vector<std::uint32_t> &,
